  ...
  >
    <SwitchPrimitives.Thumb
      className={cn(
        ...
        "after:content-['+'] after:opacity-50 data-[state=checked]:after:content-['✓'] data-[state=checked]:after:opacity-100 after:absolute after:text-[10px] after:font-bold data-[state=checked]:after:text-gray-700 after:text-gray-300",
